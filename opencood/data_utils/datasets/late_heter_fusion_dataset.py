        ...
        def collate_batch_test(self, batch):
            ...
            for cav_id, cav_content in batch.items():
                ...
                if sensor_type == 'camera':
                    ...
                    image_wh_batch = [cav_content[f"image_inputs_{modality_name}"]["image_wh"]]
                    projection_mat_batch = [cav_content[f"image_inputs_{modality_name}"]["projection_mat"]]
                        ...
                        f"inputs_{modality_name}":
                            {
                                ...
                                "image_wh": torch.stack(image_wh_batch),
                                "projection_mat": torch.stack(projection_mat_batch)
                            }
                        }
                    )
